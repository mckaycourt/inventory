...
if ($where != "") {
    if ($type == "employee") {
        $sql2 = $sql2 . " WHERE employeeId LIKE '%" . $where . "%'";
    } else {
...
echo "<div id='type' style='display: none;'>$type</div>"
...
//            var cell2 = row.insertCell(1);
        ...
        cell1.className = document.getElementById("" + k).innerHTML;
...
//            cell1.innerHTML = document.getElementById(""+i).innerHTML;
            cell2.innerHTML = document.getElementById("val-" + j + "-" + i).value;
            cell2.className = document.getElementById("" + i).innerHTML;
            if (i === 0) {
...
//            }
        ...
        cell3.innerHTML = "<a href='itemDetails.php?type=" + type + "&id=" + id + "'>Edit</a>";
    }
